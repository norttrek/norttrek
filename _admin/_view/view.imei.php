...
<div id="subcontent" >
  <div class="actions">
    <ul>
      <li><?php if($_SESSION['onUserSession']['permissions']['catalogo_imei_cre']=="on"){ ?><a href="_view/_form/frm.imei.php" class="modal fancybox.ajax">Agregar</a><?php } ?></li>
    </ul>
  </div>
  <h1 class="title"> Inventario de IMEI</h1>
  <div id="result">
    <style>
    ...
    <table id="tbl_imei" class="result" cellpadding="0" cellspacing="0" width="100%" align="center">
      <thead>
        <th align="left" width="10"></th>
        <th align="left" class="order" abbr="imei"><i class="fa fa-signal"></i> IMEI</th>
        <th align="left" class="order" abbr="device"><i class="fa fa-signal"></i> Equipo</th>
		<th align="left"></th>
      </thead>
      <tbody id="imei">
      </tbody>
...
$(document).ready(function() { 
  ...
  $(".result thead th.order").click(function(){
   ...
   table = null;
   data = {
	     table  : { id:"tbl_imei",source: "imei", action: "datagrid"},
		 filter : { limit:1000, search: null},
		 order  : { order_by: 'ca_id ASC', opt:null},
   }

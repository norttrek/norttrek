...
<div id="panel_info">
  ...
  <div class="static">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
      ...
      <td valign="top" align="right"><h5>Puedes teclear varios emails separados por coma y sin espacios.</h5></td>
      </tr>
    </table>
    <hr class="line" />
  </div>
    ...
    <table width="100%" id="tbl_alarm">
      <thead>
       <tr>
          ...
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x5" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0xA" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0xF" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x14" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x19" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x1E" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x23" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x28" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x29" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x30" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x31" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x32" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x33" class="onChkUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x34" class="onChkUpdate" /></th>

          <th style="font-size:10px; <?php if($_GET['o']==1){ echo 'display:none'; }  ?>"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x55 onEnterUpdate" /></th>
          <th style="font-size:10px; <?php if($_GET['o']==1){ echo 'display:none'; }  ?>"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x2D onEnterUpdate"/></th>
          <th style="font-size:10px; <?php if($_GET['o']==1){ echo 'display:none'; }  ?>"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x32 onEnterUpdate"/></th>
          <th style="font-size:10px; <?php if($_GET['o']==1){ echo 'display:none'; }  ?>"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x37 onEnterUpdate"/></th>
          <th style="font-size:10px; <?php if($_GET['o']==1){ echo 'display:none'; }  ?>"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x3C onEnterUpdate"/></th>
        ...
        <tr>
          ...
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Panico</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Motor Apagado</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Motor Encendido</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Bater&iacute;a Baja</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Conexi&oacute;n de Equipo</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Desconexi&oacute;n de Equipo</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Sin Movimiento (Idle)</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Bloqueo del Motor</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Desbloqueo del Motor</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Exceso de Velocidad</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Bloqueo de Marcha</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Desbloqueo de Marcha</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Cerrado de E-Lock</th>
          <th style="font-size:10px; <?php if($_GET['o']==2){ echo 'display:none'; }  ?>">Apertura de E-Lock</th>
...
for($i=0;$i<count($assets);$i++){
  ...
  if($_GET['o']==2){  $hide = 'style="display:none"'; }else{ $hide = ''; }

  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x5')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x5 onSingleUpdate" '.$checked.'/></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0xA')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0xA onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0xF')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0xF onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x14')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x14 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x19')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x19 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x1E')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x1E onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x23')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x23 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x28')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x28 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x29')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x29 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x30')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x30 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x31')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x31 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x32')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x32 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x33')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x33 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x34')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td '.$hide.'><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x34 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;

  $buffer .= '<td><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:200px; border:#ccc solid 1px; padding:5px;" placeholder="e-mail" class="x0em" value="'.$notifications[$_GET['o']].'"/></td>';
  $buffer .= '</tr>';
}
...
function save_alarm(){
  var buffer = new Array();
    ...
    if($("#a_"+data.imei+ " .0x29").val()==1){ data.settings += '0x29|'+$("#a_"+data.imei+ " .0x29").val()+','; }
    if($("#a_"+data.imei+ " .0x30").val()==1){ data.settings += '0x30|'+$("#a_"+data.imei+ " .0x30").val()+','; }
    if($("#a_"+data.imei+ " .0x31").val()==1){ data.settings += '0x31|'+$("#a_"+data.imei+ " .0x31").val()+','; }
    if($("#a_"+data.imei+ " .0x32").val()==1){ data.settings += '0x32|'+$("#a_"+data.imei+ " .0x32").val()+','; }
    if($("#a_"+data.imei+ " .0x33").val()==1){ data.settings += '0x33|'+$("#a_"+data.imei+ " .0x33").val()+','; }
    if($("#a_"+data.imei+ " .0x34").val()==1){ data.settings += '0x34|'+$("#a_"+data.imei+ " .0x34").val()+','; }
    ...
    if($("#a_"+data.imei+ " .0x2D").val()==1){ data.settings += '0x2D|'+$("#a_"+data.imei+ " .0x2D").val()+','; }
		...
		if($("#a_"+data.imei+ " input.0x2D").val() != ""){ data.settings += '0x2D|'+$("#a_"+data.imei+ " input.0x2D").val()+','; }
		if($("#a_"+data.imei+ " input.0x32").val() != ""){ data.settings += '0x32|'+$("#a_"+data.imei+ " input.0x32").val()+','; }
		if($("#a_"+data.imei+ " input.0x37").val() != ""){ data.settings += '0x37|'+$("#a_"+data.imei+ " input.0x37").val()+':'+$("#a_"+data.imei+ " input.0x3C").val()+','; }
    */

		data.email = $("#a_"+data.imei+" .x0em").val();
    console.log(data);
		buffer.push(data);
	});

	$.post('../_ctrl/ctrl.client.php', { exec: "set_alarms", data: buffer, o: <?php echo $_GET['o']; ?> },
	  function(data){
	    console.log(data);
	},"json");
}

...
$(document).ready(function(){ 
  ...
  $('.onChkGeoFence').on("change",function(){
	 ...
	 $('.onClickCmd').click(function(){ parent.objClient.set_com($(this).attr("rel").split("|")); });
  ...
  <div class="static">
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0">
      ...
      <td valign="top" style="position:relative;">
        ...
        <h1><input type="text" id="txt_name" name="txt_name" value="<?php echo $asset_info[1]['value']; ?>"></h1>
  ...
  <tr>
	...
	?>
     ...
     <ul>
        ...
        <li><div class="label">Temperatura: </div><div class="value"><?php echo substr($gprs_data[0]['temp'],0,4)/10; ?> C&deg;</div></li>
         <?php } ?>
    ...
    <div class="tab_registros isTabContent">
      <div class="registros_container datagrid">
        <table width="100%" cellpadding="1" cellspacing="1" border="0">
		  ...
		  for($i=0;$i<count($gprs_data);$i++){
			...
			<td>'.number_format($objGPRS->get_fuel_lt($sensor['fuel_a_d'],$sensor['fuel_a_l'],$sensor['fuel_a_as'],$sensor['fuel_a_v'],$sensor['fuel_a_vl'],$fuel_a),2).' L</td>
		    ...
		    <td>'.number_format((substr($gprs_data[$i]['temp'],0,4)/10),1).' C&deg;</td>
			<td>'.$speed.' km/h</td>
      ...
      <div class="registros_container datagrid">
        ...
        <p>
          ...
          <input type="text" id="name" name="name" value="<?php echo $info[1]['value'] ?>" class="inline">
          <br class="clear">
        </p>
        
        <p>
          <label class="inline">Marca <em>*</em></label>
          <input type="text" id="marca" name="marca" value="<?php echo $info[4]['value'] ?>" class="inline">
          <br class="clear">
        </p>
       ...
       <p>
          ...
          <input type="text" id="modelo" name="modelo" value="<?php echo $info[5]['value'] ?>" class="inline">
          <br class="clear">
        </p>
        
        <p>
          <label class="inline">Año <em>*</em></label>
          <input type="text" id="ano" name="ano" value="<?php echo $info[6]['value'] ?>" class="inline">
          <br class="clear">
        </p>
       
       <p>
          <label class="inline">No. Serie <em>*</em></label>
          <input type="text" id="no_serie" name="no_serie" value="<?php echo $info[7]['value'] ?>" class="inline">
          <br class="clear">
        </p>
        
        <p>
          <label class="inline">Placas<em>*</em></label>
          <input type="text" id="placas" name="placas" value="<?php echo $info[8]['value'] ?>" class="inline">
          <br class="clear">
        </p>
        
          <p>
          <label class="inline">Color<em>*</em></label>
          <input type="text" id="color" name="color" value="<?php echo $info[9]['value'] ?>" class="inline">
          <br class="clear">
        </p>
        
        <a href="#" class="onClickUpdateAsset">Guardar</a>
        </form>
      ...
      <tbody>
        ...
        <tr>
         ...
         <tr>
          ...
          <td><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 C&deg;"/></td>
          <td><input type="text" id="txt_correo[]" name="txt_correo[]" style="width:400px; border:#ccc solid 1px; padding:5px;" value="<?php echo $client_info[1]['value']; ?>" /></td>
        </tr>
        <tr>

...
#panel_info { width: 100%; height:600px; border:#e4e4e4 solid 1px;}
...
#panel_info .tabs_content { width:100%; height:470px; margin:auto; border:#e4e4e4 solid 1px; overflow-y:auto; }
...
<div id="geocercas"  class="de navmenu navmenu-default navmenu-fixed-left offcanvas" role="navigation">
<div class="col-lg-10"><h4>Reporte de Geo-Cercas</h4></div>
  <div class="col-lg-2">
    <a href="javascript:void(0)"  side="geocercas" class="Closeside btn_close  "><i class="fa fa-times fa-lg"></i></a></a>
  </div>
<div id="reports"></div>
...
.filters ul li { margin-left:0; float:left; display:inline-block; min-width:120px; margin-right:10px; }
  ...
  <ul>
    <li><select id="lst_imei" name="lst_imei">
      ...
      <?php } ?>
          <?php echo $buffer_assets; ?>
              ...
              <li>
             <input type="text" id="txt_date_from2" name="txt_date_from2" class="isDate2 isDateFrom2" value="<?php echo $objAsset->formatDate(date("Y-m-d"),"min"); ?>">
             <input id="date_from2" name="date_from" type="hidden" value="<?php echo date("Y-m-d"); ?>">
            ...
            <option value="23:59:59">23:59:59</option>
             ...
             <li>
          <input type="text" id="txt_date_to2" name="txt_date_to2" class="isDate2 isDateTo2" value="<?php echo $objAsset->formatDate(date("Y-m-d"),"min"); ?>">
          <input id="date_to2" name="date_to" type="hidden" value="<?php echo date("Y-m-d"); ?>">
        ...
        <li><a href="#"  class="onClickGetRpt btn-blue">Generar Reporte</a></li>
            </ul>
            <br class="clear">
  </div>
    ...
    $('#txt_date_from').change(function(){
        $(this).attr('value', $('#txt_date_from').val());
    });

    
    </script>
        
        <div class="geocercas" style="border:#e4e4e4 solid 1px;  position:relative; overflow-y:scroll; width:100%">
        <div class="datagrid">
 ...
 <script>
  $(document).ready(function(){
    ...
    $('#txt_date_from2').on('click',function(){ 
 ...
 $('.isDateFrom2').datepicker({
  ...
  $("#geocercas").offcanvas({ autohide: false, toggle: false  });
  </script>
</div>

    ...
    <table width="100%" id="tbl_alarm">
      <thead>
       <tr>
          ...
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x5" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0xA" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0xF" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x14" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x19" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x1E" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x23" class="onChkUpdate" /></th>
          <th style="font-size:10px;"><input id="global_setting[]" name="global_setting[]" type="checkbox" value="0x28" class="onChkUpdate" /></th>
          
    
          <th style="font-size:10px; display:none;"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x55 onEnterUpdate" /></th>
          <th style="font-size:10px; display:none;"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x5A onEnterUpdate"/></th>
          <th style="font-size:10px; display:none;"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x5F onEnterUpdate"/></th>
          <th style="font-size:10px; display:none;"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x69 onEnterUpdate"/></th>
          <th style="font-size:10px; display:none;"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" class="0x6E onEnterUpdate"/></th>
        ...
        <tr>
          ...
          <th style="font-size:10px;">Panico</th>
          <th style="font-size:10px;">Motor Apagado</th>
          <th style="font-size:10px;">Motor Encendido</th>
          <th style="font-size:10px;">Bater&iacute;a Baja</th>
          <th style="font-size:10px;">Antena GPS Conect.</th>
          <th style="font-size:10px;">Antena GPS Descon.</th>
          <th style="font-size:10px;">Movimiento (Tremble)</th>
          <th style="font-size:10px;">Sin Movimiento (Idle)</th>
          

          
          <th style="font-size:10px; display:none;">Velocidad Max.</th>
          <th style="font-size:10px; display:none;">Comb. 1 Min</th>
          <th style="font-size:10px; display:none;">Comb. 2 Min</th>
          <th style="font-size:10px; display:none;">Temp Max.</th>
          <th style="font-size:10px; display:none;">Temp Min</th>
...
for($i=0;$i<count($assets);$i++){
  ...
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x5 onSingleUpdate" '.$checked.'/></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0xA')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0xA onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0xF')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0xF onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x14')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x14 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x19')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x19 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x1E')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x1E onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x23')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x23 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  if(has_alarm($assets_alarms,$assets[$i]['imei'],'0x28')){ $checked = 'checked'; $value = 1; }
  $buffer .= '<td><input id="chk_single[]" name="chk_single[]" type="checkbox" value="'.$value.'" class="0x28 onSingleUpdate" '.$checked.' /></td>';
  $checked = '';
  $value = 0;
  
  $value = has_alarm_value($assets_alarms,$assets[$i]['imei'],'0x55');
  $buffer .= '<td style="display:none"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 km" class="0x55" value="'.$value.'" /></td>';
  $value = has_alarm_value($assets_alarms,$assets[$i]['imei'],'0x5A');
  $buffer .= '<td style="display:none"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 km" class="0x5A" value="'.$value.'" /></td>';
  $value = has_alarm_value($assets_alarms,$assets[$i]['imei'],'0x5F');
  $buffer .= '<td style="display:none"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 L" class="0x5F" value="'.$value.'" /></td>';
  $value = has_alarm_value($assets_alarms,$assets[$i]['imei'],'0x69');
  $buffer .= '<td style="display:none"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 C&deg;" class="0x69" value="'.$value.'"/></td>';
  $value = has_alarm_value($assets_alarms,$assets[$i]['imei'],'0x6E');
  $buffer .= '<td style="display:none"><input type="text" id="txt_valor[]" name="txt_valor[]" style="width:40px; border:#ccc solid 1px; padding:5px;" placeholder="0 C&deg;" class="0x6E" value="'.$value.'"/></td>';
